...
| Standards-only (optional) | `npm run test:standards` — HTML negotiation, JSON-RPC schema, JSON Patch ([`tests/standards.http.js`](../tests/standards.http.js)); also included in `npm test`. |
